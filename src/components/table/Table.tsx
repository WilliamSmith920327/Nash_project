...
const GlobalFilter = ({ preGlobalFilteredRows, globalFilter, setGlobalFilter, searchBoxClass, placehoder }: GlobalFilterProps) => {
        ...
        <div className={classNames(searchBoxClass)}>
            <span className="d-flex align-items-center">
                ...
                <input
                    ...
                    placeholder={placehoder ? placehoder : `${count} records...`}
                ...
                >
                    ...
                    <tbody {...dataTable.getTableBodyProps()}>
                        {(rows || []).map((row, i) => {
                            ...
                            return (
                                <tr {...row.getRowProps()} onClick={() => editTd(row)}>
                                    {row.cells.map((cell) => {
