import { Customer, Order, Driver, Seller } from './types';

const drivers: Driver[] = [
    {
        id: 1,
        name: 'ALEXANDRU STACI',
        category: 'GMC',
        image: 'https://robohash.org/optioanimiullam.png?size=100x100&set=set1',
        added_date: '2/17/2019',
        static_text: 'UNIT 274 - Flatbed',
        price: 451.05,
        quantity: 157,
        status: true,
    },
    {
        ...
        static_text: 'UNIT 410 - Step deck',
        price: 419.5,
        quantity: 246,
        status: true,
    },
...
export { drivers, orders, customers, sellers };
